...
import { Github, Chrome } from 'lucide-react'; // Chrome as Google placeholder if needed, or simple SVG

export const SocialButtons = () => {
  return (
    <div className="flex gap-4 w-full">
      <button 
        className="flex-1 flex items-center justify-center gap-2 bg-slate-800/50 hover:bg-slate-800 border border-slate-700/50 hover:border-slate-600 rounded-lg py-2.5 px-4 text-sm font-medium text-slate-300 transition-all duration-200 group"
        type="button"
      >
